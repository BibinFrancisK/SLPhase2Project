...
<form action="editclasses.jsp" method="post">  
...
<tr><td>Section:</td><td>   
<input type="text" maxlength="1" name="section" value="<%= u.getSection()%>" required="required"/></td></tr>
<tr><td>Subject ID:</td><td>
<input type="number" name="subject_id" value="<%= u.getSubject_id()%>" required="required"/></td></tr> 
<tr><td>Teacher ID:</td><td>
<input type="number" name="teacher_id" value="<%= u.getTeacher_id()%>"/></td></tr>   
<tr><td colspan="2"><input type="submit" class="btn btn-primary" value="Edit Class"/></td></tr>  
</table>  
</form>  
